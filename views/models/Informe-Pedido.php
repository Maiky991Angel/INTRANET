    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Reporte de Pedido </h3>
            </div>
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-responsive display nowrap">
                    ...
                    $sql = "SELECT top 5
                        ...
                        'Dev_Ventas' As Documento, Cast(Encabezado.Fecha As Varchar(11)) As 'fecha', Rtrim(Ltrim(Clientes.Razon_Social)) As 'Cliente'
